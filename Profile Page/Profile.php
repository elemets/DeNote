...
<div class="row">
<div class="col-sm-3 col-center" Style="width: 350px;">
<a href= "EditPage.php">
...
<?php
	...
	?>
							...
							<input type="submit" class="btn btn-default btn-xs submit-btn submit-font bottom-buffer" value="Delete" name="deleteBtn">
						</form>
					</div>
