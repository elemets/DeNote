...
//take scanner png
	...
	imagepng($scanner_main_to_crop, $path_scanner_main);
	...
	imagepng($scanner_bars_to_crop, $path_scanner_bars);
...
$pdf->writeHTMLCell(170, $h, 16, 75, $html_login);
...
$pdf->writeHTMLCell(158, $h, 83, 73, $html_side_menu_right);
$pdf->writeHTMLCell(158.2, $h, 83, 73, $html_side_menu_left);
...
//set phone png for near me
	$pdf->writeHTMLCell(160, $h, 146.5, 73, $html_near_me_main);
	$pdf->writeHTMLCell(27, $h, 155.5, 75, $html_near_me_logo);
	if ($html_near_me_pin == ""){
		$pdf->writeHTMLCell(290, $h, 154.5, 89, $html_near_me_custom_pin);
		$pdf->writeHTMLCell(290, $h, 176, 87.5, $html_near_me_custom_pin);
		$pdf->writeHTMLCell(290, $h, 165.5, 102.8, $html_near_me_custom_pin);
		$pdf->writeHTMLCell(290, $h, 178.7, 104.8, $html_near_me_custom_pin);
		$pdf->writeHTMLCell(290, $h, 150, 112, $html_near_me_custom_pin);
		$pdf->writeHTMLCell(290, $h, 164.5, 119.5, $html_near_me_custom_pin);
	}
	else {
		$pdf->writeHTMLCell(100, $h, 152, 89, $html_near_me_pin);
		$pdf->writeHTMLCell(100, $h, 173.5, 87.5, $html_near_me_pin);
		$pdf->writeHTMLCell(100, $h, 163, 102.8, $html_near_me_pin);
		$pdf->writeHTMLCell(100, $h, 176.2, 104.8, $html_near_me_pin);
		$pdf->writeHTMLCell(100, $h, 147.5, 112, $html_near_me_pin);
		$pdf->writeHTMLCell(100, $h, 162, 119.5, $html_near_me_pin);
	}
...
$pdf->writeHTMLCell(40.5, $h, 19.5, 183.7, $html_profile_background);
$pdf->writeHTMLCell(156.8, $h, 17.8, 183, $html_profile_front);
$pdf->writeHTMLCell(156.8, $h, 17.8, 183, $html_profile_bars);
...
$pdf->writeHTMLCell(156.8, $h, 83.2, 183, $html_offers_main);
$pdf->writeHTMLCell(156.8, $h, 83.2, 183, $html_offers_text);
...
$pdf->writeHTMLCell(40.6, $h, 148.9, 184, $html_scanner_main);
$pdf->writeHTMLCell(40.6, $h, 148.9, 184, $html_scanner_bars);
